...
{
    public class Cancel_Task_And_ChildrenExample
    {
        public static async Task Cancel_Task_And_ChildrenExampleMain()
        {
    ...
    // in this example, we pass the token to the task and we cancel using a task to cancel
}
